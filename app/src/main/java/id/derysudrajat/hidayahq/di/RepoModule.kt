package id.derysudrajat.hidayahq.di
...
import id.derysudrajat.hidayahq.repo.local.LocalDataSource
import id.derysudrajat.hidayahq.repo.local.room.AlifDatabase
import id.derysudrajat.hidayahq.repo.local.room.ReminderDao
import id.derysudrajat.hidayahq.repo.remote.RemoteDataSource
import id.derysudrajat.hidayahq.repo.remote.network.PrayerService
import id.derysudrajat.hidayahq.repo.remote.network.QuranService
